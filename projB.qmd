...
There are four deliverables in Project B: a Proposal Form, an in-person or Zoom Presentation, a Portfolio developed with Quarto ([along with your Data](#submitting-your-data)), and a Self-Evaluation Form.

1. **Proposal Form** In early April, you will submit a Google Form. 
...
2. **Presentation** After receiving our approval of your submitted form, you will prepare a portfolio of your results with Quarto, and then give an in-person or Zoom presentation of your work to Professor Love in early May. The schedule for these presentations will be resolved after the deadline for the Project B forms. 
...
4. **Self-Evaluation Form** You will each complete a self-evaluation of your Project B via a Google Form Professor Love will provide, due at the same time as the portfolio.
