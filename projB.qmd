...
There are four deliverables in Project B: a Proposal Form, an in-person or Zoom Presentation, a Portfolio developed with Quarto, and a Self-Evaluation Form.

1. **Project B Proposal Form** In early April, you will submit a Google Form. 
...
2. **Project B Presentation and Portfolio** After receiving our approval of your submitted form, you will prepare a portfolio of your results with Quarto, and then give an in-person or Zoom presentation of your work to Professor Love in early May. The schedule for these presentations will be resolved after the deadline for the Project B forms. 

3. **Project B Portfolio** You will then make changes (as needed) to your Quarto document (portfolio) in response to Professor Love's comments during your presentation, and submit the final version of the portfolio to [Canvas](https:://canvas.case.edu) by the deadline specified in the [Calendar](calendar.qmd)

4. **Project B Self-Evaluation Form** You will each complete a self-evaluation of your Project B via a Google Form Professor Love will provide, due at the same time as the portfolio.
...
If you are working with a partner...
  ...
  - you will each complete a (separate) Project B Self-Evaluation Form.

Your final Portfolio will be submitted by exactly one of the two partners to [Canvas](https::/canvas.case.edu) while the non-reporting partner will submit a one-page note to [Canvas](https::/canvas.case.edu) indicating the members of the partnership and that the partner will submit the work.
...
- whatever Professor Love needs to provide to the R Markdown file to ingest your data (this is most commonly a .csv file or series of them, but you might instead pull directly from the internet, which is also fine.)
...
If your data are not available to the public, then submit (again, with your Portfolio after your Presentation) in May:
...
The Project B Proposal Form (**link to come**) is a Google Form. The form allows you to:
...
Professor Love will make several hour-long time slots available.

- You will specify at least six of these time slots as times when you (and your partner, if any) are available to give your project.
- The time slots will be scheduled on three different days in early May.
...
Professor Love built a sample template for the Project B Portfolio, and we strongly encourage you to use it. This template is posted to our [432-data site](https://github.com/THOMASELOVE/432-data), and the `cardiac.csv` file (also found on our [432-data site](https://github.com/THOMASELOVE/432-data)) is used in the template to help fix ideas.

Any alternate template or formatting style is acceptable if it is built using Quarto and contains all of the section headings in Professor Love's template.

## What are the main section headings in the Portfolio?

The Template begins with an unnumbered section for R Preliminaries. The numbered sections we want you to use are:
...
# Modeling Restrictions (meant to be helpful)
...
Some of you want to work with data sets up to 10,000 observations and that's certainly fine, but if you propose a project where your analyses will involve more than 10,000 observations in total, you should sample from your current proposed data and then proceed with perhaps 2500 observations to begin with. It's just not worth boiling the ocean in this project. Of course, after the course is over, you can always ramp back up to a bigger version of the data set to expand the project.
